...
如果需要个性化的轮播指示器，可以将此组件和 `hi-swiper-indicator` 组件组合使用，具体效果请参考 `hi-swiper-indicator` 组件。
...
| 变量                           | 说明           | 默认值   | 版本 |
| ------------------------------ | -------------- | -------- | ---- |
| --hi-swiper-width              | 宽度           | `100%`   | -    |
| --hi-swiper-height             | 高度           | `280rpx` | -    |
| --hi-swiper-border-radius      | 圆角大小       | -        | -    |
| --hi-swiper-content-background | 插槽内容的背景 | -        | -    |
